...
public class Chat {
    public static void main(String[] args) {
        try {
            chatSession(new Scanner(System.in));
        } catch (Throwable t) {
            t.printStackTrace();
        }
    }
    ...
    public static void chatSession(Scanner inputFromUser) {
        ...
        String playerName = inputFromUser.nextLine().trim();
        ...
        try (
            ...
            while (true) {
                ...
                if (messageToSend.equalsIgnoreCase("/quit")) {
                    System.out.println("Closing chat and returning to game...");
                    break;
                }
                if (!messageToSend.equals("")) {
                    ...
                    System.out.println("@" + playerName + ": " + messageToSend);
                }
